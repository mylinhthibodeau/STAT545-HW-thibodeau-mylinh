...
### I will re-make some of the tables above with knitr::kable to compare the regular RMarkdown output to the "more readable" kable output.

I have used this [website](http://pandoc.org/installing.html) as well to install some complementary packages 

## Now I feel like I have a good grasp on how to use these new tools.
