...
p7 + 
  ...
  labs(title = "Mean life expectancy according to year", subtitle = "Box representing mean and SD for each continent")
```
...
p8 + facet_wrap(~continent) + geom_smooth(se=FALSE, method = "lm", colour = "purple", lwd = 1) + labs(title = "Life expectancy per year")
```
