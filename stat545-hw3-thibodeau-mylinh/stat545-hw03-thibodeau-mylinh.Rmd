...
I don't have a "time" value in my dataset, so I will use some equivalences for genomic data:

* Countries -> categorical variables (e.g. cancer.gene.type)
* Life expectancy -> avg.TCGA.percentile (low values will be defined as <10th percentile)
* Time -> chromosome (chr) or avg.cna.by.gene
* Continent -> cancer.gene.type
