...
tapply(d1$gene.type, d1$expression, FUN=length)  %>% kable("html") %>% kable_styling()
```
...
Aggregate in base R [here](https://stackoverflow.com/questions/1660124/how-to-sum-a-variable-by-group)
