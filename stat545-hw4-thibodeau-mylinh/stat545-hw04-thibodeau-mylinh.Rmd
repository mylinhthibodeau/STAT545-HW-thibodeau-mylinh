...
View(chek2_rna_cnv_cancer_genes_subset)
```

### GATHER: From large (wide) to tall (longer)
...
For my type of data, I think gather() is useful when I realize that a group of columns actually represent different "datasets" 
```{r}
chek2_rna_cnv_cancer_genes_subset %>%
  ...
  gather(key = tcga_data_comparator, value = tcga_percentile, SARC.percentile, avg.TCGA.percentile, avg.TCGA.norm.percentile, UCEC.norm.percentile)
