...
---
title: "html-output-stat545-hw05-thibodeau-mylinh"
...
Resource on github document format [here](http://rmarkdown.rstudio.com/github_document_format.html), on html format [here](http://rmarkdown.rstudio.com/html_document_format.html)
...
* Write some data to file and load it back into R. E.g., save a plot to file and include it in a R Markdown report- Removed for html format
