...
[here](https://stackoverflow.com/questions/40380112/categorize-continuous-variable-with-dplyr), but I did not end up using this function in the end.
...
And you can see that both plots were successfully saved: unordered_plot [here](https://github.com/mylinhthibodeau/STAT545-HW-thibodeau-mylinh/blob/master/stat545-hw5-thibodeau-mylinh/scratch-space/unordered.png) and ordered_plot [here](https://github.com/mylinhthibodeau/STAT545-HW-thibodeau-mylinh/blob/master/stat545-hw5-thibodeau-mylinh/scratch-space/ordered.png) !
