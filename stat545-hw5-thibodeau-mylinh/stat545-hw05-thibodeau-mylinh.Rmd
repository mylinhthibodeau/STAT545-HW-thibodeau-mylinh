...
## The examples of using read input and write ouput to a file are scattered across this homework !

* It starts in the section "Get the data and clean the data" where I used read.table() to load the data into chek2_rna_cnv
...
write.table(hugo_colors, "chek2-hugo-colors.tsv",
...
write.table(d5.cancer.gene.type, "chek2-cancer.gene.type-colors.tsv",
            quote = FALSE, sep = "\t", row.names = FALSE)
```
...
![a_plot](scratch-space/chek2_cancer_gene_type_color.png)
