...
**Note 1.** I know you can't read anything in this image, but I have put it simply to give you an idea, as it would be hard to make 1281 gene names (hugo) fit on a screen ! To see the png, you can click [HERE](https://github.com/mylinhthibodeau/STAT545-HW-thibodeau-mylinh/blob/master/stat545-hw5-thibodeau-mylinh/scratch-space/chek2-cancer.gene.type-colors.png)
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
And you can see that both plots were successfully saved: unordered\_plot [here](https://github.com/mylinhthibodeau/STAT545-HW-thibodeau-mylinh/blob/master/stat545-hw5-thibodeau-mylinh/scratch-space/unordered.png) and ordered\_plot [here](https://github.com/mylinhthibodeau/STAT545-HW-thibodeau-mylinh/blob/master/stat545-hw5-thibodeau-mylinh/scratch-space/ordered.png) !
...
-   change labels on x-axis example [here](https://stackoverflow.com/questions/27418222/two-lines-of-x-axis-labels-in-ggplot)
...
-   Exception made of the homework 1 (which is [here](https://github.com/mylinhthibodeau/STAT545-hw01-thibodeau-mylinh)), all of the stat545 homework assignements are in my mylinhthibodeau/STAT545-HW-thibodeau-mylinh repository [here](https://github.com/mylinhthibodeau/STAT545-HW-thibodeau-mylinh). I will eventually try to move homework 1 to this folder, but I am a bit fearful to re-create my "repository inside a repository" issue, so I will wait to have more time to tackle eventual problems before I do so.
