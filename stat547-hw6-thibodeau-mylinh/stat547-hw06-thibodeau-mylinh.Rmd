...
### Create a nested list with multiple levels

In this section, I will create 3 nested lists (d2, d4, d6) containing data information of 3 TCGA datasets (DLBC, GBM, LUAD), and then I will make a list of these 3 lists called "list_d".
...
### Explore some purrr mapping

#### Individual list exploration (e.g. d2)
...
### Explore the nested list_d 

Let's look at the first 2 levels of our nested list_d.
```{r}
str(list_d, max.level = 2)
str(list_d[3], list.len = 1) # Look at the first level of the 3rd list in list_d, which is the LUAD dataset.
#list_d[[1]][c("samples")]
