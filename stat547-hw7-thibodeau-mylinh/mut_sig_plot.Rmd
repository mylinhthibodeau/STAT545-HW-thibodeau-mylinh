...
ALL_mut_p1 <- ALL_mut_gather %>%
	group_by(case_id) %>%
	ggplot(aes(x=case_id, y=number)) +
	geom_point()
ggsave("plots/ALL_mut_p1.pdf", ALL_mut_p1 , width = 10, height =6)
```
...
aml_mut_p1 <- aml_mut_gather %>%
	...
	ggplot(aes(x=case_id, y=number)) +
	geom_point()
ggsave("plots/aml_mut_p1.pdf", aml_mut_p1 , width = 10, height =6)
```
...
breast_mut_p1 <- breast_mut_gather %>%
	...
	ggplot(aes(x=case_id, y=number)) +
	geom_point()
ggsave("plots/breast_mut_p1.pdf", breast_mut_p1, width = 10, height =6)
```
...
medullo_mut_p1 <- medullo_mut_gather %>%
	...
	ggplot(aes(x=case_id, y=number)) +
	geom_point()
ggsave("plots/medullo_mut_p1.pdf", medullo_mut_p1 , width = 10, height =6)
```
...
pancreas_mut_p1 <- pancreas_mut_gather %>%
	...
	ggplot(aes(x=case_id, y=number)) +
	geom_point()
ggsave("plots/pancreas_mut_p1.pdf", pancreas_mut_p1 , width = 10, height =6)
```
