...
all_cancer_types_mut_with_ref_sig_fraction <- read.table("somatic_mutations_formated_files/all_cancer_types_mut_with_ref_sig_fraction.tsv", header = TRUE, sep = "\t")
...
head(ALL_mut_gather)
head(aml_mut_gather)
head(breast_mut_gather)
head(medullo_mut_gather)
head(pancreas_mut_gather)
head(all_cancer_types_mut)
head(all_cancer_types_mut_with_ref_sig)
head(all_cancer_types_mut_proportion_signatures)
head(all_cancer_types_mut_with_ref_sig_fraction)
```
