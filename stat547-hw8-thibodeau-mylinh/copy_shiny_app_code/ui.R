...
# SECTION 1		
		tabPanel(
			...
			wellPanel(
				radioButtons(inputId = "frequency_user_input", label = "Pick a expected frequency of the phenotype for the genomic disorder(s): ", choices = 
					c("Very frequent (99-80%)", "Frequent (79-30%)", "Occasional (29-5%)", "Obligate (100%)", "Excluded (0%)")
					)
				),
	
			tableOutput(outputId = "examples_syndromes"),
...
# SECTION 2
		tabPanel(
			...
			tableOutput(outputId = "syndromes_and_organs"),
